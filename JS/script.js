...
/* RECUPERANDO O BOTÃO PARA QUE SEJA REALIZADO O PROCEDIMENTO DE DISPARO DO EVENTO DE VALIDAÇÃO */

const botaoSubmit = document.getElementById('btnEnviar')

//ATRELAR UM EVENTO AO BOTÃO, PARA QUE QUANDO FOR CLICADO, EU POSSA EXECUTAR UMA FUNÇÃO
